...
/*Linked List-- A linear data structure in which elements are not stored at
    contiguous location, linked to each other with Nodes.
    Time/Space- O(n)
    Adv: Dynamic size, Insertion/deletion(at any node), flexibility
    Dis: Random access- donot allow direct access to elements by index. Traversal is required,
         Extra memory
*/
